 ...
 * comment:同时访问不同的同步方法
 */
public class SynchronizedMethodAndYesSameException implements Runnable{

    private static SynchronizedMethodAndYesSameException instance = new SynchronizedMethodAndYesSameException();
